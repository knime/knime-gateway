...
import com.knime.gateway.json.entity.WebViewEntMixIn;
import com.knime.gateway.json.entity.WebView_viewRepresentationEntMixIn;
import com.knime.gateway.json.entity.WebView_viewValueEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(WebViewEntMixIn.class);
        res.add(WebView_viewRepresentationEntMixIn.class);
        res.add(WebView_viewValueEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(WebViewEntMixIn.WebViewEntMixInBuilder.class);
        res.add(WebView_viewRepresentationEntMixIn.WebView_viewRepresentationEntMixInBuilder.class);
        res.add(WebView_viewValueEntMixIn.WebView_viewValueEntMixInBuilder.class);
