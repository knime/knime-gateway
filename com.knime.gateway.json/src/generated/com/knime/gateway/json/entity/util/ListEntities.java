...
import com.knime.gateway.json.entity.MetaNodeDialogComp_configEntMixIn;
import com.knime.gateway.json.entity.MetaNodeDialogComp_representationEntMixIn;
import com.knime.gateway.json.entity.MetaNodeDialogComp_valueEntMixIn;
...
import com.knime.gateway.json.entity.ViewContentEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(MetaNodeDialogComp_configEntMixIn.class);
        res.add(MetaNodeDialogComp_representationEntMixIn.class);
        res.add(MetaNodeDialogComp_valueEntMixIn.class);
        ...
        res.add(ViewContentEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(MetaNodeDialogComp_configEntMixIn.MetaNodeDialogComp_configEntMixInBuilder.class);
        res.add(MetaNodeDialogComp_representationEntMixIn.MetaNodeDialogComp_representationEntMixInBuilder.class);
        res.add(MetaNodeDialogComp_valueEntMixIn.MetaNodeDialogComp_valueEntMixInBuilder.class);
        ...
        res.add(ViewContentEntMixIn.ViewContentEntMixInBuilder.class);
