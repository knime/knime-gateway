...
import com.knime.gateway.json.entity.ExecutionStatisticsEntMixIn;
...
import com.knime.gateway.json.entity.NodeExecutedStatisticsEntMixIn;
import com.knime.gateway.json.entity.NodeExecutingStatisticsEntMixIn;
...
import com.knime.gateway.json.entity.ViewTemplateEntMixIn;
import com.knime.gateway.json.entity.WizardPageEntMixIn;
...
import com.knime.gateway.json.entity.WorkflowPartsEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(ViewTemplateEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(ViewTemplateEntMixIn.ViewTemplateEntMixInBuilder.class);
