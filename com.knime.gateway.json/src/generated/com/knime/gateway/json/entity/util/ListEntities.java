...
import com.knime.gateway.json.entity.ViewData_viewRepresentationEntMixIn;
import com.knime.gateway.json.entity.ViewData_viewValueEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(ViewData_viewRepresentationEntMixIn.class);
        res.add(ViewData_viewValueEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(ViewData_viewRepresentationEntMixIn.ViewData_viewRepresentationEntMixInBuilder.class);
        res.add(ViewData_viewValueEntMixIn.ViewData_viewValueEntMixInBuilder.class);
