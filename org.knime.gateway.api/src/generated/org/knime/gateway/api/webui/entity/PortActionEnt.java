...
public interface PortActionEnt extends GatewayEntity {
  ...
  /**
   * TODO add will add a new port underneath the current port
   */
  ...
  public String getPortGroupName();
    ...
    public interface PortActionEntBuilder extends GatewayEntityBuilder<PortActionEnt> {
        ...
        /**
   		 * Set supportedPortTypes
         * 
         * @param supportedPortTypes the property value,  
         * @return this entity builder for chaining
         */
        PortActionEntBuilder setSupportedPortTypes(java.util.List<String> supportedPortTypes);
