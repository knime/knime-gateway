...
public interface AllowedConnectionActionsEnt extends GatewayEntity {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
      ...
      var e = (AllowedConnectionActionsEnt)other;
     ...
     */
    public interface AllowedConnectionActionsEntBuilder extends GatewayEntityBuilder<AllowedConnectionActionsEnt> {
         ...
         */
        AllowedConnectionActionsEntBuilder setCanDelete(Boolean canDelete);
        ...
        */
        @Override
        AllowedConnectionActionsEnt build();
