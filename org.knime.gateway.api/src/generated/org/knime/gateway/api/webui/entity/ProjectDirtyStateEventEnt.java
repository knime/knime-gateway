...
public interface ProjectDirtyStateEventEnt extends GatewayEntity, EventEnt {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
      ...
      valueConsumer.accept("projectIdToIsDirty", Pair.create(getProjectIdToIsDirty(), e.getProjectIdToIsDirty()));
  }
    ...
    public interface ProjectDirtyStateEventEntBuilder extends GatewayEntityBuilder<ProjectDirtyStateEventEnt> {
         ...
         * Mapping from project id to isDirty flag of workflow.
         * 
         * @param projectIdToIsDirty the property value,  
         * @return this entity builder for chaining
         */
        ProjectDirtyStateEventEntBuilder setProjectIdToIsDirty(java.util.Map<String, Boolean> projectIdToIsDirty);
