...
public interface PortGroupEnt extends GatewayEntity {
  ...
  /**
   * Whether a dynamic port can be added to this group
   * @return canAddPort 
   **/
  public Boolean isCanAddPort();

  /**
   * The IDs of port types supported by this port group.
  ...
  public java.util.List<String> getSupportedPortTypeIds();
    ...
    public interface PortGroupEntBuilder extends GatewayEntityBuilder<PortGroupEnt> {
         ...
         */
        PortGroupEntBuilder setName(String name);
        
        /**
         * Whether a dynamic port can be added to this group
         * 
         * @param canAddPort the property value,  
         * @return this entity builder for chaining
         */
        PortGroupEntBuilder setCanAddPort(Boolean canAddPort);
