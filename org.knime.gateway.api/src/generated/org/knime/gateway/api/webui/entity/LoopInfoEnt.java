...
public interface LoopInfoEnt extends GatewayEntity {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
     ...
     */
    public interface LoopInfoEntBuilder extends GatewayEntityBuilder<LoopInfoEnt> {
         ...
         */
        LoopInfoEntBuilder setAllowedActions(AllowedLoopActionsEnt allowedActions);
         ...
         * @return this entity builder for chaining
         */
        LoopInfoEntBuilder setStatus(StatusEnum status);
