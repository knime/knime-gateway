...
public interface CopyCommandEnt extends GatewayEntity, PartBasedCommandEnt {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
     ...
     */
    public interface CopyCommandEntBuilder extends GatewayEntityBuilder<CopyCommandEnt> {
         ...
         */
        CopyCommandEntBuilder setKind(KindEnum kind);
         ...
         * @return this entity builder for chaining
         */
        CopyCommandEntBuilder setNodeIds(java.util.List<org.knime.gateway.api.entity.NodeIDEnt> nodeIds);
         ...
         * @return this entity builder for chaining
         */
        CopyCommandEntBuilder setAnnotationIds(java.util.List<org.knime.gateway.api.entity.AnnotationIDEnt> annotationIds);
