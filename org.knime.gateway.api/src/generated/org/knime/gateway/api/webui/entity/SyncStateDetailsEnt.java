...
public interface SyncStateDetailsEnt extends GatewayEntity {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
      ...
      var e = (SyncStateDetailsEnt)other;
     ...
     */
    public interface SyncStateDetailsEntBuilder extends GatewayEntityBuilder<SyncStateDetailsEnt> {
         ...
         */
        SyncStateDetailsEntBuilder setCode(String code);
         ...
         * @return this entity builder for chaining
         */
        SyncStateDetailsEntBuilder setTitle(String title);
         ...
         * @return this entity builder for chaining
         */
        SyncStateDetailsEntBuilder setDetails(java.util.List<String> details);
         ...
         * @return this entity builder for chaining
         */
        SyncStateDetailsEntBuilder setCanCopy(Boolean canCopy);
         ...
         * @return this entity builder for chaining
         */
        SyncStateDetailsEntBuilder setStatus(Integer status);
         ...
         * @return this entity builder for chaining
         */
        SyncStateDetailsEntBuilder setStackTrace(String stackTrace);
