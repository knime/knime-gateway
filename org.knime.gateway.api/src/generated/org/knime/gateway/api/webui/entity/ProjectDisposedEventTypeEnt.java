...
public interface ProjectDisposedEventTypeEnt extends GatewayEntity, EventTypeEnt {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
      ...
      var e = (ProjectDisposedEventTypeEnt)other;
     ...
     */
    public interface ProjectDisposedEventTypeEntBuilder extends GatewayEntityBuilder<ProjectDisposedEventTypeEnt> {
         ...
         * @return this entity builder for chaining
         */
        ProjectDisposedEventTypeEntBuilder setProjectId(String projectId);
        ...
        */
        @Override
        ProjectDisposedEventTypeEnt build();
