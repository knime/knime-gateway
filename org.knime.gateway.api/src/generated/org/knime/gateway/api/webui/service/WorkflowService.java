...
public interface WorkflowService extends GatewayService {
     ...
     * @throws ServiceExceptions.ServiceCallException If a Gateway service call failed for some reason.
     */
    CommandResultEnt executeWorkflowCommand(String projectId, org.knime.gateway.api.entity.NodeIDEnt workflowId, WorkflowCommandEnt workflowCommand)  throws ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException, ServiceExceptions.ServiceCallException;
     ...
     * @throws ServiceExceptions.ServiceCallException If a Gateway service call failed for some reason.
     */
    WorkflowSnapshotEnt getWorkflow(String projectId, org.knime.gateway.api.entity.NodeIDEnt workflowId, String versionId, Boolean includeInteractionInfo)  throws ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException, ServiceExceptions.NodeNotFoundException, ServiceExceptions.NotASubWorkflowException, ServiceExceptions.ServiceCallException;
     ...
     * @throws ServiceExceptions.ServiceCallException If a Gateway service call failed for some reason.
     */
    void redoWorkflowCommand(String projectId, org.knime.gateway.api.entity.NodeIDEnt workflowId)  throws ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException, ServiceExceptions.ServiceCallException;
     ...
     * @throws ServiceExceptions.ServiceCallException If a Gateway service call failed for some reason.
     */
    void saveProject(String projectId)  throws ServiceExceptions.NetworkException, ServiceExceptions.LoggedOutException, ServiceExceptions.ServiceCallException;
     ...
     * @throws ServiceExceptions.ServiceCallException If a Gateway service call failed for some reason.
     */
    void undoWorkflowCommand(String projectId, org.knime.gateway.api.entity.NodeIDEnt workflowId)  throws ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException, ServiceExceptions.ServiceCallException;
