...
public interface ProblemMessageEnt extends GatewayEntity {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
     ...
     */
    public interface ProblemMessageEntBuilder extends GatewayEntityBuilder<ProblemMessageEnt> {
         ...
         */
        ProblemMessageEntBuilder setType(TypeEnum type);
         ...
         * @return this entity builder for chaining
         */
        ProblemMessageEntBuilder setTitle(String title);
         ...
         * @return this entity builder for chaining
         */
        ProblemMessageEntBuilder setMessage(String message);
