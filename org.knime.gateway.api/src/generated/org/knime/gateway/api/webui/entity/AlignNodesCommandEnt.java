...
public interface AlignNodesCommandEnt extends GatewayEntity, PartBasedCommandEnt {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
    ...
    public interface AlignNodesCommandEntBuilder extends GatewayEntityBuilder<AlignNodesCommandEnt> {
         ...
         * @return this entity builder for chaining
         */
        AlignNodesCommandEntBuilder setAnnotationIds(java.util.List<org.knime.gateway.api.entity.AnnotationIDEnt> annotationIds);
         ...
         * @return this entity builder for chaining
         */
        AlignNodesCommandEntBuilder setConnectionBendpoints(java.util.Map<String, java.util.List<Integer>> connectionBendpoints);
