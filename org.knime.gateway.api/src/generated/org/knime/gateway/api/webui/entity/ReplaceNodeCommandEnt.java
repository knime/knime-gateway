...
public interface ReplaceNodeCommandEnt extends GatewayEntity, WorkflowCommandEnt {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
      ...
      valueConsumer.accept("replacementNodeId", Pair.create(getReplacementNodeId(), e.getReplacementNodeId()));
  }
    ...
    public interface ReplaceNodeCommandEntBuilder extends GatewayEntityBuilder<ReplaceNodeCommandEnt> {
         ...
         * @return this entity builder for chaining
         */
        ReplaceNodeCommandEntBuilder setTargetNodeId(org.knime.gateway.api.entity.NodeIDEnt targetNodeId);
         ...
         * An existing node id to be used for replacement
         * 
         * @param replacementNodeId the property value,  
         * @return this entity builder for chaining
         */
        ReplaceNodeCommandEntBuilder setReplacementNodeId(org.knime.gateway.api.entity.NodeIDEnt replacementNodeId);
