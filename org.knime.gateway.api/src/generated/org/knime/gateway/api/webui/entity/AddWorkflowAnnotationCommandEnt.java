...
public interface AddWorkflowAnnotationCommandEnt extends GatewayEntity, WorkflowCommandEnt {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
     ...
     */
    public interface AddWorkflowAnnotationCommandEntBuilder extends GatewayEntityBuilder<AddWorkflowAnnotationCommandEnt> {
         ...
         */
        AddWorkflowAnnotationCommandEntBuilder setKind(KindEnum kind);
        ...
        */
        @Override
        AddWorkflowAnnotationCommandEnt build();
