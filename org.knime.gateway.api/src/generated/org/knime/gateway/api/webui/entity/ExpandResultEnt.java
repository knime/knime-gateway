...
public interface ExpandResultEnt extends GatewayEntity, CommandResultEnt {
  ...
  /**
   * Get expandedNodeIds
   * @return expandedNodeIds , never <code>null</code>
   **/
  public java.util.List<org.knime.gateway.api.entity.NodeIDEnt> getExpandedNodeIds();

  /**
   * Get expandedAnnotationIds
   * @return expandedAnnotationIds , never <code>null</code>
   **/
  ...
  default void forEachPropertyValue(final GatewayEntity other,
     ...
     */
    public interface ExpandResultEntBuilder extends GatewayEntityBuilder<ExpandResultEnt> {
         ...
         */
        ExpandResultEntBuilder setSnapshotId(String snapshotId);
         ...
         * @return this entity builder for chaining
         */
        ExpandResultEntBuilder setKind(KindEnum kind);
        
        /**
   		 * Set expandedNodeIds
         * 
         * @param expandedNodeIds the property value, NOT <code>null</code>! 
         * @return this entity builder for chaining
         */
        ExpandResultEntBuilder setExpandedNodeIds(java.util.List<org.knime.gateway.api.entity.NodeIDEnt> expandedNodeIds);
        
        /**
   		 * Set expandedAnnotationIds
         * 
         * @param expandedAnnotationIds the property value, NOT <code>null</code>! 
         * @return this entity builder for chaining
         */
        ExpandResultEntBuilder setExpandedAnnotationIds(java.util.List<org.knime.gateway.api.entity.AnnotationIDEnt> expandedAnnotationIds);
