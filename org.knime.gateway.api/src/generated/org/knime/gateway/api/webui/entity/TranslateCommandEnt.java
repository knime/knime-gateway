...
public interface TranslateCommandEnt extends GatewayEntity, PartBasedCommandEnt {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
    ...
    public interface TranslateCommandEntBuilder extends GatewayEntityBuilder<TranslateCommandEnt> {
         ...
         * @return this entity builder for chaining
         */
        TranslateCommandEntBuilder setConnectionBendpoints(java.util.Map<String, java.util.List<Integer>> connectionBendpoints);
         ...
         * @return this entity builder for chaining
         */
        TranslateCommandEntBuilder setMetanodeOutPortsBar(Boolean metanodeOutPortsBar);
