...
public interface ComponentNodeEnt extends GatewayEntity, NodeEnt, ComponentNodeAndDescriptionEnt {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
      ...
      valueConsumer.accept("configContentVersion", Pair.create(getConfigContentVersion(), e.getConfigContentVersion()));
    ...
    public interface ComponentNodeEntBuilder extends GatewayEntityBuilder<ComponentNodeEnt> {
        ...
        /**
         * A change in this value signals that the configuration of a node has been changed.  Applies only to nodes under the UI-extensions, modern dialog framework.
         * 
         * @param configContentVersion the property value,  
         * @return this entity builder for chaining
         */
        ComponentNodeEntBuilder setConfigContentVersion(Integer configContentVersion);
         ...
         * @return this entity builder for chaining
         */
        ComponentNodeEntBuilder setInputContentVersion(Integer inputContentVersion);
