...
public interface ComponentService extends GatewayService {
     ...
     * @throws ServiceExceptions.NodeNotFoundException The requested node was not found.
     */
    java.util.List<LinkVariantInfoEnt> getLinkVariants(String projectId, org.knime.gateway.api.entity.NodeIDEnt workflowId, org.knime.gateway.api.entity.NodeIDEnt nodeId)  throws ServiceExceptions.ServiceCallException, ServiceExceptions.NodeNotFoundException;
