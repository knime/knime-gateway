...
public interface ComponentService extends GatewayService {
     ...
     * @throws ServiceExceptions.ServiceCallException If a Gateway service call failed for some reason.
     */
    void triggerComponentReexecution(String projectId, org.knime.gateway.api.entity.NodeIDEnt workflowId, org.knime.gateway.api.entity.NodeIDEnt nodeId, String resetNodeIdSuffix, java.util.Map<String, String> stateUpdates)  throws ServiceExceptions.ServiceCallException;
