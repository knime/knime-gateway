...
public interface NodeViewEnt extends GatewayEntity {
  ...
  /**
   * Relative or absolute path to the html document representing the node view. TODO e.g. for debugging an absolute path is provided
   * @return iframeSrc 
   **/
  public String getIframeSrc();

  /**
   * Id of the (vue) component to be used for the node view.
