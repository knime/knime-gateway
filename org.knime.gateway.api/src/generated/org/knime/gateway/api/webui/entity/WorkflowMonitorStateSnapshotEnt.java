...
public interface WorkflowMonitorStateSnapshotEnt extends GatewayEntity {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
      ...
      var e = (WorkflowMonitorStateSnapshotEnt)other;
     ...
     */
    public interface WorkflowMonitorStateSnapshotEntBuilder extends GatewayEntityBuilder<WorkflowMonitorStateSnapshotEnt> {
         ...
         */
        WorkflowMonitorStateSnapshotEntBuilder setState(WorkflowMonitorStateEnt state);
         ...
         * @return this entity builder for chaining
         */
        WorkflowMonitorStateSnapshotEntBuilder setSnapshotId(String snapshotId);
        ...
        */
        @Override
        WorkflowMonitorStateSnapshotEnt build();
