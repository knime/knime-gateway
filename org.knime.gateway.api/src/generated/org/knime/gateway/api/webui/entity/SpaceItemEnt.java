...
public interface SpaceItemEnt extends GatewayEntity {
  ...
  default void forEachPropertyValue(final GatewayEntity other,
     ...
     */
    public interface SpaceItemEntBuilder extends GatewayEntityBuilder<SpaceItemEnt> {
         ...
         */
        SpaceItemEntBuilder setId(String id);
         ...
         * @return this entity builder for chaining
         */
        SpaceItemEntBuilder setName(String name);
         ...
         * @return this entity builder for chaining
         */
        SpaceItemEntBuilder setType(TypeEnum type);
