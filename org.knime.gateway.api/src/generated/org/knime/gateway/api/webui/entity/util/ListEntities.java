...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(NodeDialogEnt.NodeDialogEntBuilder.class);
        ...
        res.add(SingleNodeEnt.SingleNodeEntBuilder.class);
