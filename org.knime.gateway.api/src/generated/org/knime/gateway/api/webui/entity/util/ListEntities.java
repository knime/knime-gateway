...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(UpdateStateChangedEventEnt.class);
        res.add(UpdateStateChangedEventTypeEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(UpdateStateChangedEventEnt.UpdateStateChangedEventEntBuilder.class);
        res.add(UpdateStateChangedEventTypeEnt.UpdateStateChangedEventTypeEntBuilder.class);
