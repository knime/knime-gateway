...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(ComponentSearchItemEnt.class);
        res.add(ComponentSearchItemPortEnt.class);
        ...
        res.add(InsertionOptionsEnt.class);
        res.add(ItemVersionEnt.class);
        res.add(JobManagerEnt.class);
        res.add(KaiFeedbackEnt.class);
        res.add(KaiInquiryEnt.class);
        res.add(KaiInquiryOptionEnt.class);
        res.add(KaiInquiryResponseEnt.class);
        ...
        res.add(MostRecentEnt.class);
        res.add(NamedItemVersionEnt.class);
        ...
        res.add(ReplacementOptionsEnt.class);
        res.add(SelectionEventEnt.class);
        res.add(ShareComponentCommandEnt.class);
        res.add(ShareComponentResultEnt.class);
        ...
        res.add(SpecificVersionEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(AutoConnectOptionsEnt.AutoConnectOptionsEntBuilder.class);
        ...
        res.add(ChangeComponentLinkCommandEnt.ChangeComponentLinkCommandEntBuilder.class);
        ...
        res.add(ComponentSearchItemEnt.ComponentSearchItemEntBuilder.class);
        res.add(ComponentSearchItemPortEnt.ComponentSearchItemPortEntBuilder.class);
        ...
        res.add(CurrentStateEnt.CurrentStateEntBuilder.class);
        ...
        res.add(InsertionOptionsEnt.InsertionOptionsEntBuilder.class);
        res.add(ItemVersionEnt.ItemVersionEntBuilder.class);
        res.add(JobManagerEnt.JobManagerEntBuilder.class);
        res.add(KaiFeedbackEnt.KaiFeedbackEntBuilder.class);
        res.add(KaiInquiryEnt.KaiInquiryEntBuilder.class);
        res.add(KaiInquiryOptionEnt.KaiInquiryOptionEntBuilder.class);
        res.add(KaiInquiryResponseEnt.KaiInquiryResponseEntBuilder.class);
        ...
        res.add(MostRecentEnt.MostRecentEntBuilder.class);
        res.add(NamedItemVersionEnt.NamedItemVersionEntBuilder.class);
        ...
        res.add(ReplacementOptionsEnt.ReplacementOptionsEntBuilder.class);
        res.add(SelectionEventEnt.SelectionEventEntBuilder.class);
        res.add(ShareComponentCommandEnt.ShareComponentCommandEntBuilder.class);
        res.add(ShareComponentResultEnt.ShareComponentResultEntBuilder.class);
        ...
        res.add(SpecificVersionEnt.SpecificVersionEntBuilder.class);
