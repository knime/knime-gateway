...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(AddPlaceholderResultEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(AddPlaceholderResultEnt.AddPlaceholderResultEntBuilder.class);
        ...
        res.add(PlaceholderEnt.PlaceholderEntBuilder.class);
