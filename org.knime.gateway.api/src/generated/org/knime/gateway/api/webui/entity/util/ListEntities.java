...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(ComponentConfigurationLayoutEnt.class);
        res.add(ComponentConfigurationLayoutNodeEnt.class);
        res.add(ComponentConfigurationLayoutTableEnt.class);
        res.add(ComponentLayoutEnt.class);
        ...
        res.add(ComponentViewLayoutEnt.class);
        res.add(ComponentViewLayoutNodeEnt.class);
        res.add(ComponentViewLayoutTableEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(ComponentConfigurationLayoutEnt.ComponentConfigurationLayoutEntBuilder.class);
        res.add(ComponentConfigurationLayoutNodeEnt.ComponentConfigurationLayoutNodeEntBuilder.class);
        res.add(ComponentConfigurationLayoutTableEnt.ComponentConfigurationLayoutTableEntBuilder.class);
        res.add(ComponentLayoutEnt.ComponentLayoutEntBuilder.class);
        ...
        res.add(ComponentViewLayoutEnt.ComponentViewLayoutEntBuilder.class);
        res.add(ComponentViewLayoutNodeEnt.ComponentViewLayoutNodeEntBuilder.class);
        res.add(ComponentViewLayoutTableEnt.ComponentViewLayoutTableEntBuilder.class);
