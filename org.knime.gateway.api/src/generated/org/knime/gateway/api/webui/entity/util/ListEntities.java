...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(NodePortInvariantsEnt.class);
        res.add(NodeSearchResultEnt.class);
        res.add(NodeSelectionEnt.class);
        res.add(NodeSelectionsEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(NodePortInvariantsEnt.NodePortInvariantsEntBuilder.class);
        res.add(NodeSearchResultEnt.NodeSearchResultEntBuilder.class);
        res.add(NodeSelectionEnt.NodeSelectionEntBuilder.class);
        res.add(NodeSelectionsEnt.NodeSelectionsEntBuilder.class);
