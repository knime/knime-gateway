...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(SpaceProviderAndConnectionEnt.class);
        res.add(SpaceProviderEnt.class);
        res.add(SpaceProvidersChangedEventEnt.class);
        res.add(SpaceProvidersChangedEventTypeEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(SpaceProviderAndConnectionEnt.SpaceProviderAndConnectionEntBuilder.class);
        res.add(SpaceProviderEnt.SpaceProviderEntBuilder.class);
        res.add(SpaceProvidersChangedEventEnt.SpaceProvidersChangedEventEntBuilder.class);
        res.add(SpaceProvidersChangedEventTypeEnt.SpaceProvidersChangedEventTypeEntBuilder.class);
