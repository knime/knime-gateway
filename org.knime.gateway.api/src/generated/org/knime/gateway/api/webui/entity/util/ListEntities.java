...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(SuggestAnnotationPayloadEnt.class);
        res.add(SuggestAnnotationRequestEnt.class);
        res.add(SuggestAnnotationResponseEnt.class);
        res.add(SuggestAnnotationResultEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(SuggestAnnotationPayloadEnt.SuggestAnnotationPayloadEntBuilder.class);
        res.add(SuggestAnnotationRequestEnt.SuggestAnnotationRequestEntBuilder.class);
        res.add(SuggestAnnotationResponseEnt.SuggestAnnotationResponseEntBuilder.class);
        res.add(SuggestAnnotationResultEnt.SuggestAnnotationResultEntBuilder.class);
