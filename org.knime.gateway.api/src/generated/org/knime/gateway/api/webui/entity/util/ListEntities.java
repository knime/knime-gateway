...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(HubResourceChangedEventEnt.class);
        res.add(HubResourceChangedEventTypeEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(HubResourceChangedEventEnt.HubResourceChangedEventEntBuilder.class);
        res.add(HubResourceChangedEventTypeEnt.HubResourceChangedEventTypeEntBuilder.class);
