...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(TranslateOperationEnt.class);
        ...
        res.add(WorkflowOperationEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(TranslateOperationEnt.TranslateOperationEntBuilder.class);
        ...
        res.add(WorkflowOperationEnt.WorkflowOperationEntBuilder.class);
