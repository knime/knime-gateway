...
public final class WorkflowBuildContext {
    ...
    private final Collection<PlaceholderEnt> m_placeholders;
    ...
    private WorkflowBuildContext(final WorkflowManager wfm, final WorkflowBuildContextBuilder builder,
        ...
        final DependentNodeProperties depNodeProps, final Collection<PlaceholderEnt> placeholders) {
        m_wfm = wfm;
    ...
    Collection<PlaceholderEnt> getPlacerholders() {
    ...
    public static final class WorkflowBuildContextBuilder {
        ...
        private Collection<PlaceholderEnt> m_placeholders;
         ...
         * @return
         */
        public WorkflowBuildContextBuilder setPlaceholders(final Collection<PlaceholderEnt> placeholders) {
            m_placeholders = placeholders;
            return this;
        }
        ...
        WorkflowBuildContext build(final WorkflowManager wfm) {
            ...
            return new WorkflowBuildContext(wfm, this, CoreUtil.isInStreamingMode(wfm),
                ...
                m_placeholders == null ? List.of() : m_placeholders);
        }
