...
/**
 * Data value view entity containing the info required by the UI (i.e. frontend) to be able to display a data value
 * view.
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 */
public class DataValueViewEnt extends UIExtensionEnt<DataValueWrapper> {
