 ...
 * type).
 *
 * All gateway service methods that are intended to invoke a method on a particular KNIME executor are required to
 ...
 *
 * All gateway service methods are assumed to be thread-safe.
 *
