...
public class NativeNodeEntTest {
    ...
    public static NativeNodeEnt createEnt(final List<Object> valueList) {
		...
		builder.setNodeFactoryKey(NodeFactoryKeyEntTest.createEnt((List<Object>) valueList.get(0)));
    ...
    public static void testEnt(final NativeNodeEnt ent, final List<Object> valueList) {
		NodeFactoryKeyEntTest.testEnt(ent.getNodeFactoryKey(), (List<Object>) valueList.get(0));
    ...
    public static List<Object> createValueList() {
        List<Object> valueList = new ArrayList<Object>();
 		valueList.add(NodeFactoryKeyEntTest.createValueList());
