...
public class PortTypeEntTest {
    ...
    public static PortTypeEnt createEnt(final List<Object> valueList) {
		...
		builder.setPortObjectClassName((String) valueList.get(0));
		builder.setIsOptional((boolean) valueList.get(1));
        return builder.build();
    }

    public static void testEnt(final PortTypeEnt ent, final List<Object> valueList) {
		assertEquals(ent.getPortObjectClassName(), (String) valueList.get(0));
		assertEquals(ent.getIsOptional(), (boolean) valueList.get(1));
    }
