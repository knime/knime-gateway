...
/**
 * Builder for {@link NodeFactoryKeyEnt}.
...
public interface NodeFactoryKeyEntBuilder extends GatewayEntityBuilder<NodeFactoryKeyEnt> {
    ...
    /**
     * @param settings Additional settings in order to be able to re-create nodes. Only required in case of 'dynamic' node factories.
     * @return <code>this</code>
     */
	NodeFactoryKeyEntBuilder setSettings(Optional<String> settings);
