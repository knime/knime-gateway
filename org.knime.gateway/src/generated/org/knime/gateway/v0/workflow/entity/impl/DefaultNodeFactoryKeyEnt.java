...
/**
 * Default implementation of the NodeFactoryKeyEnt-interface. E.g. used if no other {@link EntityBuilderFactory}
...
public class DefaultNodeFactoryKeyEnt implements NodeFactoryKeyEnt {
	...
	private Optional<String> m_Settings;

    /**
     * @param builder
     */
    DefaultNodeFactoryKeyEnt(final DefaultNodeFactoryKeyEntBuilder builder) {
	...
	public static DefaultNodeFactoryKeyEntBuilder builder() {
		return new DefaultNodeFactoryKeyEntBuilder();
	}
}
