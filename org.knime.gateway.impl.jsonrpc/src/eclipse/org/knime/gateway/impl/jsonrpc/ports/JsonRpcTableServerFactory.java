 ...
 */
public class JsonRpcTableServerFactory extends AbstractPortJsonRpcServerFactory<TableService> {

    /**
     * New factory instance.
     */
    public JsonRpcTableServerFactory() {
        super(BuildInWebPortViewType.TABLE);
    }

    @Override
    protected TableService createService(final NodeOutPort port) {
        return new DefaultTableService(port);
    }
