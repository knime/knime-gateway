...
public class JsonRpcSpaceServiceWrapper implements SpaceService {
    ...
    public java.util.List<ComponentSearchItemEnt> searchComponents(@JsonRpcParam(value="spaceProviderId") String spaceProviderId, @JsonRpcParam(value="query") String query, @JsonRpcParam(value="limit") Integer limit, @JsonRpcParam(value="offset") Integer offset)  throws ServiceExceptions.ServiceCallException, ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException {
        return m_service.get().searchComponents(spaceProviderId, query, limit, offset);
    }
