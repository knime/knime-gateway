...
public class JsonRpcSpaceServiceWrapper implements SpaceService {
     ...
     */
    @Override
    @JsonRpcMethod(value = "getAncestorInfo")
    @JsonRpcErrors(value = {
        @JsonRpcError(exception = ServiceExceptions.ServiceCallException.class, code = -32600,
            data = "ServiceCallException" /*per convention the data property contains the exception name*/),
        @JsonRpcError(exception = ServiceExceptions.LoggedOutException.class, code = -32600,
     ...
     */
    @Override
    @JsonRpcMethod(value = "getLinkVariantsForItem")
    @JsonRpcErrors(value = {
        @JsonRpcError(exception = ServiceExceptions.ServiceCallException.class, code = -32600,
            data = "ServiceCallException" /*per convention the data property contains the exception name*/),
        @JsonRpcError(exception = ServiceExceptions.LoggedOutException.class, code = -32600,
    ...
    public java.util.List<LinkVariantInfoEnt> getLinkVariantsForItem(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="spaceId") String spaceId, @JsonRpcParam(value="spaceProviderId") String spaceProviderId, @JsonRpcParam(value="itemId") String itemId)  throws ServiceExceptions.ServiceCallException, ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException {
        return m_service.get().getLinkVariantsForItem(projectId, spaceId, spaceProviderId, itemId);    
    }
    ...
    public java.util.List<SpaceGroupEnt> getSpaceGroups(@JsonRpcParam(value="spaceProviderId") String spaceProviderId)  throws ServiceExceptions.ServiceCallException, ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException {
    ...
    public SpaceItemEnt renameItem(@JsonRpcParam(value="spaceProviderId") String spaceProviderId, @JsonRpcParam(value="spaceId") String spaceId, @JsonRpcParam(value="itemId") String itemId, @JsonRpcParam(value="itemName") String itemName)  throws ServiceExceptions.ServiceCallException, ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException, ServiceExceptions.OperationNotAllowedException {
    ...
    public SpaceEnt renameSpace(@JsonRpcParam(value="spaceProviderId") String spaceProviderId, @JsonRpcParam(value="spaceId") String spaceId, @JsonRpcParam(value="spaceName") String spaceName)  throws ServiceExceptions.ServiceCallException, ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException, ServiceExceptions.OperationNotAllowedException {
     ...
     */
    @Override
    @JsonRpcMethod(value = "searchComponents")
    @JsonRpcErrors(value = {
        @JsonRpcError(exception = ServiceExceptions.ServiceCallException.class, code = -32600,
            data = "ServiceCallException" /*per convention the data property contains the exception name*/),
        @JsonRpcError(exception = ServiceExceptions.LoggedOutException.class, code = -32600,
    ...
    public java.util.List<ComponentSearchItemEnt> searchComponents(@JsonRpcParam(value="query") String query, @JsonRpcParam(value="limit") Integer limit, @JsonRpcParam(value="offset") Integer offset, @JsonRpcParam(value="portSide") String portSide, @JsonRpcParam(value="portId") String portId)  throws ServiceExceptions.ServiceCallException, ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException {
        return m_service.get().searchComponents(query, limit, offset, portSide, portId);    
    }
