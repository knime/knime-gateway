...
public class JsonRpcComponentEditorServiceWrapper implements ComponentEditorService {
    ...
    public String getNodes(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="workflowId") org.knime.gateway.api.entity.NodeIDEnt workflowId, @JsonRpcParam(value="nodeId") org.knime.gateway.api.entity.NodeIDEnt nodeId)  throws ServiceExceptions.ServiceCallException {
        return m_service.get().getNodes(projectId, workflowId, nodeId);    
    }
     ...
     */
    @Override
    @JsonRpcMethod(value = "pushLayout")
    @JsonRpcErrors(value = {
        @JsonRpcError(exception = ServiceExceptions.ServiceCallException.class, code = -32600,
            data = "ServiceCallException" /*per convention the data property contains the exception name*/)
    })
    public void pushLayout(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="workflowId") org.knime.gateway.api.entity.NodeIDEnt workflowId, @JsonRpcParam(value="nodeId") org.knime.gateway.api.entity.NodeIDEnt nodeId, @JsonRpcParam(value="componentViewLayout") String componentViewLayout)  throws ServiceExceptions.ServiceCallException {
        m_service.get().pushLayout(projectId, workflowId, nodeId, componentViewLayout);    
    }
