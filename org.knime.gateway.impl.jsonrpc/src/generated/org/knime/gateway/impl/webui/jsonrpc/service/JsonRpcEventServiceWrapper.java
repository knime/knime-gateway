...
public class JsonRpcEventServiceWrapper implements EventService {
    ...
    public void addEventListener(@JsonRpcParam(value="eventType") EventTypeEnt eventType)  throws ServiceExceptions.ServiceCallException {
    ...
    public void removeEventListener(@JsonRpcParam(value="eventType") EventTypeEnt eventType)  {
        m_service.get().removeEventListener(eventType);    
    }
