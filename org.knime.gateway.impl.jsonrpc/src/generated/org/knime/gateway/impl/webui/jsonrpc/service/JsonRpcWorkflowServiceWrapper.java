...
public class JsonRpcWorkflowServiceWrapper implements WorkflowService {
    ...
    public void restoreVersion(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="version") String version)  throws ServiceExceptions.ServiceCallException, ServiceExceptions.LoggedOutException, ServiceExceptions.NetworkException {
