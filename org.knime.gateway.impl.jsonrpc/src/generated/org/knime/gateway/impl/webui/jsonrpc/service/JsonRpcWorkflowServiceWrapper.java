...
public class JsonRpcWorkflowServiceWrapper implements WorkflowService {
    ...
    public WorkflowSnapshotEnt getWorkflow(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="workflowId") org.knime.gateway.api.entity.NodeIDEnt workflowId, Boolean includeInfoOnAllowedActions)  throws ServiceExceptions.NotASubWorkflowException, ServiceExceptions.NodeNotFoundException {
        return m_service.getWorkflow(projectId, workflowId, includeInfoOnAllowedActions);    
    }
