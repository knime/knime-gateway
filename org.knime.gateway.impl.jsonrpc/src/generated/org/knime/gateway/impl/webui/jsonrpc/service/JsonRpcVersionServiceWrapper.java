...
public class JsonRpcVersionServiceWrapper implements VersionService {
     ...
     */
    @Override
    @JsonRpcMethod(value = "getProjectVersions")
    @JsonRpcErrors(value = {
    ...
    public java.util.List<ProjectVersionEnt> getProjectVersions(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="workflowId") org.knime.gateway.api.entity.NodeIDEnt workflowId, @JsonRpcParam(value="limit") Integer limit)  throws ServiceExceptions.ServiceCallException {
        return m_service.get().getProjectVersions(projectId, workflowId, limit);    
    }
