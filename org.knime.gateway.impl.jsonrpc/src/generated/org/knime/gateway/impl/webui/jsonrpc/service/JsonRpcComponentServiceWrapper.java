...
public class JsonRpcComponentServiceWrapper implements ComponentService {
     ...
     */
    @Override
    @JsonRpcMethod(value = "getUrlVariants")
    @JsonRpcErrors(value = {
        @JsonRpcError(exception = ServiceExceptions.ServiceCallException.class, code = -32600,
            data = "ServiceCallException" /*per convention the data property contains the exception name*/),
    ...
    public java.util.List<LinkVariantEnt> getUrlVariants(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="workflowId") org.knime.gateway.api.entity.NodeIDEnt workflowId, @JsonRpcParam(value="nodeId") org.knime.gateway.api.entity.NodeIDEnt nodeId)  throws ServiceExceptions.ServiceCallException, ServiceExceptions.NodeNotFoundException {
        return m_service.get().getUrlVariants(projectId, workflowId, nodeId);    
    }
