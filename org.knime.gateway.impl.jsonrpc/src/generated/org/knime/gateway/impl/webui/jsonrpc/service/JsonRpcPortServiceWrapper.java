...
public class JsonRpcPortServiceWrapper implements PortService {
    ...
    public String callPortDataService(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="workflowId") org.knime.gateway.api.entity.NodeIDEnt workflowId, @JsonRpcParam(value="nodeId") org.knime.gateway.api.entity.NodeIDEnt nodeId, @JsonRpcParam(value="portIdx") Integer portIdx, @JsonRpcParam(value="viewIdx") Integer viewIdx, @JsonRpcParam(value="serviceType") String serviceType, @JsonRpcParam(value="dataServiceRequest") String dataServiceRequest)  throws ServiceExceptions.NodeNotFoundException, ServiceExceptions.InvalidRequestException {
        return m_service.get().callPortDataService(projectId, workflowId, nodeId, portIdx, viewIdx, serviceType, dataServiceRequest);    
    }
    ...
    public Object getDataValueView(@JsonRpcParam(value="projectId") final String projectId, @JsonRpcParam(value="workflowId") final org.knime.gateway.api.entity.NodeIDEnt workflowId, @JsonRpcParam(value="nodeId") final org.knime.gateway.api.entity.NodeIDEnt nodeId, @JsonRpcParam(value="portIdx") final Integer portIdx, @JsonRpcParam(value="rowIdx") final Integer rowIdx, @JsonRpcParam(value="colIdx") final Integer colIdx)  throws ServiceExceptions.NodeNotFoundException, ServiceExceptions.InvalidRequestException {
        return m_service.get().getDataValueView(projectId, workflowId, nodeId, portIdx, rowIdx, colIdx);
    }
    ...
    public Object getPortView(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="workflowId") org.knime.gateway.api.entity.NodeIDEnt workflowId, @JsonRpcParam(value="nodeId") org.knime.gateway.api.entity.NodeIDEnt nodeId, @JsonRpcParam(value="portIdx") Integer portIdx, @JsonRpcParam(value="viewIdx") Integer viewIdx)  throws ServiceExceptions.NodeNotFoundException, ServiceExceptions.InvalidRequestException {
        return m_service.get().getPortView(projectId, workflowId, nodeId, portIdx, viewIdx);    
    }
    ...
    public void updateDataPointSelection(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="workflowId") org.knime.gateway.api.entity.NodeIDEnt workflowId, @JsonRpcParam(value="nodeId") org.knime.gateway.api.entity.NodeIDEnt nodeId, @JsonRpcParam(value="portIdx") Integer portIdx, @JsonRpcParam(value="viewIdx") Integer viewIdx, @JsonRpcParam(value="mode") String mode, @JsonRpcParam(value="selection") java.util.List<String> selection)  throws ServiceExceptions.NodeNotFoundException {
        m_service.get().updateDataPointSelection(projectId, workflowId, nodeId, portIdx, viewIdx, mode, selection);    
    }
