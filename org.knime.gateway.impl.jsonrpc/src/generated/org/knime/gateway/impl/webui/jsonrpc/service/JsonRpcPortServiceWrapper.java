...
public class JsonRpcPortServiceWrapper implements PortService {
    ...
    public Object getDataValueView(@JsonRpcParam(value="projectId") String projectId, @JsonRpcParam(value="workflowId") org.knime.gateway.api.entity.NodeIDEnt workflowId, @JsonRpcParam(value="nodeId") org.knime.gateway.api.entity.NodeIDEnt nodeId, @JsonRpcParam(value="portIdx") Integer portIdx, @JsonRpcParam(value="rowIdx") Integer rowIdx, @JsonRpcParam(value="colIdx") Integer colIdx, @JsonRpcParam(value="viewIdx") Integer viewIdx)  throws ServiceExceptions.NodeNotFoundException, ServiceExceptions.InvalidRequestException {
        return m_service.get().getDataValueView(projectId, workflowId, nodeId, portIdx, rowIdx, colIdx, viewIdx);    
    }
