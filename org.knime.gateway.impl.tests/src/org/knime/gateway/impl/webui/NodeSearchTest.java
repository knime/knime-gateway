...
public class NodeSearchTest {
    ...
    public void testSearchNodesAllNullParameters() throws Exception {
        ...
        m_search.searchNodes(null, null, null, null, null, null, "", NodeRelation.SUCCESSORS); // Identical to first one
    ...
    public void testSearchNodesDifferentPortTypesAndDirections() throws Exception {
        var res1 = m_search.searchNodes("a", null, null, null, null, Boolean.TRUE, TABLE_PORT_TYPE_ID, NodeRelation.SUCCESSORS);
        ...
        var res2 = m_search.searchNodes("a", null, null, null, null, Boolean.TRUE, IMAGE_PORT_TYPE_ID, NodeRelation.SUCCESSORS);
        assertThat(res2.getTotalNumNodesFound(), greaterThan(0));
        assertThat("There should only be nodes with at least one compatible port type",
            everyNodeHasInputPortOfType(res2.getNodes(), IMAGE_PORT_TYPE_ID), is(true));

        var res3 =
            m_search.searchNodes("a", null, null, null, null, Boolean.TRUE, FLOW_VARIABLE_PORT_TYPE_ID, NodeRelation.SUCCESSORS);
        ...
        var res5 = m_search.searchNodes("a", null, null, null, null, Boolean.TRUE, TABLE_PORT_TYPE_ID, NodeRelation.SUCCESSORS);
        assertThat(res5.getTotalNumNodesFound(), greaterThan(0));
        assertThat("There should only be nodes with at least one compatible port type",
            everyNodeHasInputPortOfType(res5.getNodes(), TABLE_PORT_TYPE_ID), is(true));

        var res6 = m_search.searchNodes("a", null, null, null, null, Boolean.TRUE, IMAGE_PORT_TYPE_ID, NodeRelation.SUCCESSORS);
