...
public class DefaultComponentServiceTest extends GatewayServiceTest {
    ...
    public void reexecuteComponentViaBooleanWidget() throws Exception {
        ...
        var csv = new DefaultCompositeViewService();
        ...
        var compositeViewPage =
            (String)csv.getCompositeViewPage(projectId, NodeIDEnt.getRootID(), null, new NodeIDEnt("root:3"));
        ...
        csv.triggerComponentReexecution(projectId, NodeIDEnt.getRootID(), new NodeIDEnt("root:3"), "3:0:4", Map
            .of("3:0:4", "{\"@class\":\"org.knime.js.base.node.base.input.bool.BooleanNodeValue\",\"boolean\":true}"));
        var reexecutionStatus =
            csv.pollComponentReexecutionStatus(projectId, NodeIDEnt.getRootID(), new NodeIDEnt("root:3"), "3:0:4");
