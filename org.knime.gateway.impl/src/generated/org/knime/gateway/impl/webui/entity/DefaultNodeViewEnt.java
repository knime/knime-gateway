...
public class DefaultNodeViewEnt implements NodeViewEnt {
  ...
  private DefaultNodeViewEnt(DefaultNodeViewEntBuilder builder) {
    ...
    if(builder.m_available == null) {
        throw new IllegalArgumentException("available must not be null.");
    }
    m_available = immutable(builder.m_available);
  }
   ...
   /**
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(m_name, ent.m_name) && Objects.equals(m_available, ent.m_available);
    }
  ...
  public Boolean isAvailable() {
    ...
    public static class DefaultNodeViewEntBuilder implements NodeViewEntBuilder {
        ...
        @Override
        public DefaultNodeViewEntBuilder setName(String name) {
             if(name == null) {
                 throw new IllegalArgumentException("name must not be null.");
             }
             m_name = name;
        ...
        @Override
        public DefaultNodeViewEntBuilder setAvailable(Boolean available) {
             if(available == null) {
                 throw new IllegalArgumentException("available must not be null.");
             }
