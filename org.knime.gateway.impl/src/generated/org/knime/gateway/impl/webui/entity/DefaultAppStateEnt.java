...
public class DefaultAppStateEnt  implements AppStateEnt {
  ...
  public java.util.List<WorkflowSnapshotEnt> getActiveWorkflows() {
    ...
    public static class DefaultAppStateEntBuilder implements AppStateEntBuilder {
        ...
        @Override
        public DefaultAppStateEntBuilder setActiveWorkflows(java.util.List<WorkflowSnapshotEnt> activeWorkflows) {
             m_activeWorkflows = activeWorkflows;
             return this;
        }
