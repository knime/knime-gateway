...
public record DefaultNativeNodeEnt(
    ...
    public static class DefaultNativeNodeEntBuilder implements NativeNodeEntBuilder {
        ...
        @Override
        public DefaultNativeNodeEntBuilder setDialogType(DialogTypeEnum dialogType) {
             m_dialogType = dialogType;
             return this;
        }

        @Override
        public DefaultNativeNodeEntBuilder setConfigContentVersion(Integer configContentVersion) {
