...
public record DefaultProjectDirtyStateEventEnt(
    java.util.Map<String, Boolean> projectIdToIsDirty) implements ProjectDirtyStateEventEnt {
    ...
    public static class DefaultProjectDirtyStateEventEntBuilder implements ProjectDirtyStateEventEntBuilder {
        ...
        private java.util.Map<String, Boolean> m_projectIdToIsDirty;

        @Override
        public DefaultProjectDirtyStateEventEntBuilder setProjectIdToIsDirty(java.util.Map<String, Boolean> projectIdToIsDirty) {
             m_projectIdToIsDirty = projectIdToIsDirty;
             return this;
        }
        ...
        public DefaultProjectDirtyStateEventEnt build() {
            return new DefaultProjectDirtyStateEventEnt(
                immutable(m_projectIdToIsDirty));
        }
