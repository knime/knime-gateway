...
public record DefaultComponentNodeEnt(
    ...
    public static class DefaultComponentNodeEntBuilder implements ComponentNodeEntBuilder {
        ...
        private Integer m_configContentVersion;
        ...
        @Override
        public DefaultComponentNodeEntBuilder setDialogType(DialogTypeEnum dialogType) {
             m_dialogType = dialogType;
             return this;
        }

        @Override
        public DefaultComponentNodeEntBuilder setConfigContentVersion(Integer configContentVersion) {
             m_configContentVersion = configContentVersion;
             return this;
        }
        ...
        public DefaultComponentNodeEnt build() {
            return new DefaultComponentNodeEnt(
                ...
                immutable(m_configContentVersion),
