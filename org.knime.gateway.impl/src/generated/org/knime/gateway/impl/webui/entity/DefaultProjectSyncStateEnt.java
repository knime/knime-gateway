...
public record DefaultProjectSyncStateEnt(
    ...
    SyncStateDetailsEnt details) implements ProjectSyncStateEnt {
    ...
    public static class DefaultProjectSyncStateEntBuilder implements ProjectSyncStateEntBuilder {
        ...
        private SyncStateDetailsEnt m_details;
        ...
        @Override
        public DefaultProjectSyncStateEntBuilder setDetails(SyncStateDetailsEnt details) {
             m_details = details;
             return this;
        }
