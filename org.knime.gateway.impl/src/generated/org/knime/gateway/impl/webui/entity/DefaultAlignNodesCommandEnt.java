...
public record DefaultAlignNodesCommandEnt(
    ...
    public static class DefaultAlignNodesCommandEntBuilder implements AlignNodesCommandEntBuilder {
        ...
        @Override
        public DefaultAlignNodesCommandEntBuilder setAnnotationIds(java.util.List<org.knime.gateway.api.entity.AnnotationIDEnt> annotationIds) {
             if(annotationIds == null) {
                 throw new IllegalArgumentException("<annotationIds> must not be null.");
             }
        ...
        @Override
        public DefaultAlignNodesCommandEntBuilder setConnectionBendpoints(java.util.Map<String, java.util.List<Integer>> connectionBendpoints) {
