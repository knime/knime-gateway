...
/**
 * DefaultComponentSearchItemPortEnt
 *
 * @param name
 * @param description
 * @param portTypeName
...
public record DefaultComponentSearchItemPortEnt(
    String name,
    String description,
    String portTypeName,
    String color,
    ...
    public String getTypeID() {
        return "ComponentSearchItemPort";
    }
    ...
    /**
     * A builder for {@link DefaultComponentSearchItemPortEnt}.
     */
    public static class DefaultComponentSearchItemPortEntBuilder implements ComponentSearchItemPortEntBuilder {
        ...
        @Override
        public DefaultComponentSearchItemPortEntBuilder setDescription(String description) {
        ...
        @Override
        public DefaultComponentSearchItemPortEntBuilder setOptional(Boolean optional) {
             m_optional = optional;
             return this;
        }

        @Override
        public DefaultComponentSearchItemPortEnt build() {
            return new DefaultComponentSearchItemPortEnt(
                immutable(m_name),
