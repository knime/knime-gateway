...
public record DefaultPasteResultEnt(
    ...
    public static class DefaultPasteResultEntBuilder implements PasteResultEntBuilder {
        ...
        @Override
        public DefaultPasteResultEntBuilder setSnapshotId(String snapshotId) {
             m_snapshotId = snapshotId;
             return this;
        }

        @Override
        public DefaultPasteResultEntBuilder setKind(KindEnum kind) {
             m_kind = kind;
             return this;
        }

        @Override
        public DefaultPasteResultEntBuilder setNodeIds(java.util.List<org.knime.gateway.api.entity.NodeIDEnt> nodeIds) {
             m_nodeIds = nodeIds;
             return this;
        }

        @Override
        public DefaultPasteResultEntBuilder setAnnotationIds(java.util.List<org.knime.gateway.api.entity.AnnotationIDEnt> annotationIds) {
