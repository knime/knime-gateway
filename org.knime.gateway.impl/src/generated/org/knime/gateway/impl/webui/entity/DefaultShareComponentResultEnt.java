...
/**
 * DefaultShareComponentResultEnt
 *
 * @param snapshotId
 * @param kind
...
public record DefaultShareComponentResultEnt(
     ...
     */
    public static class DefaultShareComponentResultEntBuilder implements ShareComponentResultEntBuilder {
        ...
        @Override
        public DefaultShareComponentResultEntBuilder setKind(KindEnum kind) {
             m_kind = kind;
             return this;
        }
