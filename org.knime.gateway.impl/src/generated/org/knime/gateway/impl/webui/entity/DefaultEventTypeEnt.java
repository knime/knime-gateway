...
/**
 * Event type (sub-types) are used to describe the type of events one wants to register for. An event type is parameterized by it&#39;s properties (defined in sub-types).
 *
