...
import org.knime.gateway.impl.webui.entity.DefaultSyncStateEnt;
...
public class Interface2ImplMap {
    ...
    public static <B extends GatewayEntityBuilder> B create(final Class<B> clazz) {
        ...
        if(clazz == SyncStateEntBuilder.class) {
            return (B)new DefaultSyncStateEnt.DefaultSyncStateEntBuilder();
        }        
