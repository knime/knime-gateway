...
import org.knime.gateway.api.webui.entity.BendpointCommandEnt.BendpointCommandEntBuilder;
...
import org.knime.gateway.api.webui.entity.RemoveBendpointCommandEnt.RemoveBendpointCommandEntBuilder;
...
import org.knime.gateway.impl.webui.entity.DefaultBendpointCommandEnt;
...
import org.knime.gateway.impl.webui.entity.DefaultRemoveBendpointCommandEnt;
...
public class Interface2ImplMap {
    ...
    public static <B extends GatewayEntityBuilder> B create(final Class<B> clazz) {
        ...
        if (clazz == BendpointCommandEntBuilder.class) {
            return (B)new DefaultBendpointCommandEnt.DefaultBendpointCommandEntBuilder();
        }
        ...
        if (clazz == RemoveBendpointCommandEntBuilder.class) {
            return (B)new DefaultRemoveBendpointCommandEnt.DefaultRemoveBendpointCommandEntBuilder();
        }
