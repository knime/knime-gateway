...
public record DefaultPlaceholderNodeEnt(
    ...
    TypeEnum type,
    String message) implements PlaceholderNodeEnt {

    /**
     * Validation for required parameters not being {@code null}.
     */
    public DefaultPlaceholderNodeEnt {
        if(id == null) {
    ...
    /**
     * A builder for {@link DefaultPlaceholderNodeEnt}.
     */
    public static class DefaultPlaceholderNodeEntBuilder implements PlaceholderNodeEntBuilder {
        ...
        @Override
        public DefaultPlaceholderNodeEntBuilder setId(org.knime.gateway.api.entity.NodeIDEnt id) {
             if(id == null) {
                 throw new IllegalArgumentException("<id> must not be null.");
             }
             m_id = id;
        ...
        @Override
        public DefaultPlaceholderNodeEntBuilder setInPorts(java.util.List<? extends NodePortEnt> inPorts) {
             if(inPorts == null) {
                 throw new IllegalArgumentException("<inPorts> must not be null.");
             }
             m_inPorts = inPorts;
        ...
        @Override
        public DefaultPlaceholderNodeEntBuilder setOutPorts(java.util.List<? extends NodePortEnt> outPorts) {
             if(outPorts == null) {
                 throw new IllegalArgumentException("<outPorts> must not be null.");
             }
             m_outPorts = outPorts;
        ...
        @Override
        public DefaultPlaceholderNodeEntBuilder setAnnotation(NodeAnnotationEnt annotation) {
             m_annotation = annotation;
             return this;
        }

        @Override
        public DefaultPlaceholderNodeEntBuilder setPosition(XYEnt position) {
             if(position == null) {
                 throw new IllegalArgumentException("<position> must not be null.");
             }
             m_position = position;
        ...
        @Override
        public DefaultPlaceholderNodeEntBuilder setKind(KindEnum kind) {
             if(kind == null) {
                 throw new IllegalArgumentException("<kind> must not be null.");
             }
             m_kind = kind;
        ...
        @Override
        public DefaultPlaceholderNodeEntBuilder setDialogType(DialogTypeEnum dialogType) {
             m_dialogType = dialogType;
             return this;
        }

        @Override
        public DefaultPlaceholderNodeEntBuilder setInputContentVersion(Integer inputContentVersion) {
             m_inputContentVersion = inputContentVersion;
             return this;
        }

        @Override
        public DefaultPlaceholderNodeEntBuilder setAllowedActions(AllowedNodeActionsEnt allowedActions) {
             m_allowedActions = allowedActions;
             return this;
        }

        @Override
        public DefaultPlaceholderNodeEntBuilder setExecutionInfo(NodeExecutionInfoEnt executionInfo) {
             m_executionInfo = executionInfo;
             return this;
        }

        @Override
        public DefaultPlaceholderNodeEntBuilder setType(TypeEnum type) {
             if(type == null) {
                 throw new IllegalArgumentException("<type> must not be null.");
             }
             m_type = type;
        ...
        @Override
        public DefaultPlaceholderNodeEntBuilder setMessage(String message) {
             m_message = message;
             return this;
        }

        @Override
        public DefaultPlaceholderNodeEnt build() {
            return new DefaultPlaceholderNodeEnt(
                immutable(m_id),
                immutable(m_inPorts),
