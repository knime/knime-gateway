...
public class DefaultAddNodeResultEnt implements AddNodeResultEnt {

  protected String m_snapshotId;
  protected KindEnum m_kind;
  protected org.knime.gateway.api.entity.NodeIDEnt m_newNodeId;
  
  protected DefaultAddNodeResultEnt() {
    //for sub-classes
  }
  ...
  private DefaultAddNodeResultEnt(DefaultAddNodeResultEntBuilder builder) {
    super();
   ...
   /**
    ...
    public boolean equals(final Object o) {
        ...
        DefaultAddNodeResultEnt ent = (DefaultAddNodeResultEnt)o;
  ...
  public org.knime.gateway.api.entity.NodeIDEnt getNewNodeId() {
    ...
    public static class DefaultAddNodeResultEntBuilder implements AddNodeResultEntBuilder {
        ...
        public DefaultAddNodeResultEntBuilder(){
            super();
        }
        ...
        public DefaultAddNodeResultEnt build() {
            return new DefaultAddNodeResultEnt(this);
        }
