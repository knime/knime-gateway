...
public record DefaultMetaNodePortEnt(
    String name,
    String typeId,
    Boolean optional,
    String info,
    ...
    /**
     * Canonical constructor for {@link DefaultMetaNodePortEnt} including null checks for non-nullable parameters.
     *
     * @param name
     * @param typeId
     * @param optional
    ...
    /**
     * A builder for {@link DefaultMetaNodePortEnt}.
     */
    public static class DefaultMetaNodePortEntBuilder implements MetaNodePortEntBuilder {
        ...
        public DefaultMetaNodePortEnt build() {
            return new DefaultMetaNodePortEnt(
                immutable(m_name),
                immutable(m_typeId),
