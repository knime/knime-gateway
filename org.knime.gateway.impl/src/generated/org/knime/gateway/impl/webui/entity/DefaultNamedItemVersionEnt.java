...
public record DefaultNamedItemVersionEnt(
    ...
    String description,
    String author,
    String createdOn) implements NamedItemVersionEnt {
    ...
    public static class DefaultNamedItemVersionEntBuilder implements NamedItemVersionEntBuilder {
        ...
        @Override
        public DefaultNamedItemVersionEntBuilder setVersion(BigDecimal version) {
             m_version = version;
             return this;
        }
        ...
        @Override
        public DefaultNamedItemVersionEntBuilder setCreatedOn(String createdOn) {
