 ...
 * @author baqueroj
 */
class TableViewSortActionToNodeTransformer extends TableViewActionToNodeTranformer {

    SortActionParameters parameters;

    public TableViewSortActionToNodeTransformer(final SortActionParameters parameters, final String projectId, final NodeIDEnt workflowId,
        final WorkflowManager wfm) {
        super("org.knime.base.node.preproc.sorter.SorterNodeFactory", projectId, workflowId, wfm);
