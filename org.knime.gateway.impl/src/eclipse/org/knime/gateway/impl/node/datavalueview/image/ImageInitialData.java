 ...
 * @param mimeType the media type of the image
 * @author Paul Bärnreuther
 */
record ImageInitialData(byte[] data, String mimeType) {

    ImageInitialData(final SVGDocument svg) {
        this(getDataFromDocument(svg), "image/svg+xml");
    }
