...
/**
 * A view associated to an {@link ImageValue}.
 *
 * @author Paul Bärnreuther
 */
interface ImageValueView extends DataValueView {
    ...
    @Override
    default Optional<InitialDataService<ImageInitialData>> createInitialDataService() {
        return Optional.of(InitialDataService.builder(this::getInitialData).build());
    }

    ImageInitialData getInitialData();
