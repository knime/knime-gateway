...
/**
 * A {@link PatchCreator} that creates {@link PatchEnt PatchEnts}.
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 */
public final class PatchEntCreator implements PatchCreator<PatchEnt> {
    ...
    /**
     * @return the snapshot id of the last patch that has been created via this patch creator
     */
