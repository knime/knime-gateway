...
import static org.knime.gateway.api.util.EntityBuilderUtil.buildNodeEnt;
import static org.knime.gateway.api.util.EntityTranslateUtil.translateNodeCreationConfiguration;
import static org.knime.gateway.impl.service.util.DefaultServiceUtil.getNodeContainer;
import static org.knime.gateway.impl.service.util.DefaultServiceUtil.getRootWfmAndNc;
...
public class DefaultNodeService implements NodeService {
    ...
    public NodeIDEnt createNode(final UUID rootWorkflowID, final NodeIDEnt parentNodeID, final Integer x,
        ...
        try {
            nodeFactory = FileNativeNodeContainerPersistor.loadNodeFactory(nodeFactoryKey.getClassName());
