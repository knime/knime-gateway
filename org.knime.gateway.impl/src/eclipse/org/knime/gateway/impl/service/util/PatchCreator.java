...
/**
 * Processes changes between gateway entities as patch operations in order to create a patch object.
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 * @param <P> the patch object
 */
public interface PatchCreator<P> {

    /**
     * Object has been replaced
     *
     * @param path to the property replaced
     * @param value the new value
     */
    void replaced(String path, Object value);

    /**
     * Called when a new object has been added (before {@link #added(String, Object)} is called).
     *
     ...
     *
     * @param path path to the property added
