...
//    }
    ...
    public void saveProject(final String projectId) throws ServiceCallException, LoggedOutException, NetworkException {
        ...
        DefaultServiceContext.assertWorkflowProjectId(projectId);
        final var workflowSyncer = m_workflowSyncerProvider.getWorkflowSyncerForContext(Key.of(projectId));
        try {
            workflowSyncer.syncProjectNow();
        } catch (final IOException e) { // NOSONAR
            throw ServiceCallException.builder() // This will be the "code" for the exception in the FE
                .withTitle("This is the title") //
                .withDetails("detail1", "detail2") //
                .canCopy(true) // Needed
                .withCause(e) // Needed
                .withAdditionalProp("addProp1", "value1") // Not needed
                .withAdditionalProp("addProp2", "value2") // Not needed
                .withStatusCode(418) // Maybe needed for network exceptions
                .build();
        }
    }
