...
final class LocalSaver {
     ...
     * @throws UnsupportedOperationException if the workflow is a component project
     */
    private static void assertIsWorkflowProject(final WorkflowManager wfm) {
        if (wfm.isComponentProjectWFM()) {
            throw new UnsupportedOperationException("Saving component project is not supported");
        }
    }
