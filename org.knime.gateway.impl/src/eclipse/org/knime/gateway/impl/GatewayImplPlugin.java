...
public class GatewayImplPlugin implements BundleActivator {
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        NodeDialogManager.registerNodeDialogFactory(VirtualSubNodeInputNodeFactory.class.getName(),
            () -> new DefaultNodeDialog(SettingsType.MODEL, VirtualSubNodeInputParameters.class));
        NodeDialogManager.registerNodeDialogFactory(VirtualSubNodeOutputNodeFactory.class.getName(),
