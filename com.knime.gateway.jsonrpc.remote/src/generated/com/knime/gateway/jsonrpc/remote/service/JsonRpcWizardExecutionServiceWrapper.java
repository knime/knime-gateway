...
public class JsonRpcWizardExecutionServiceWrapper implements WizardExecutionService {
    ...
    @JsonRpcErrors(value = {
        @JsonRpcError(exception = ServiceExceptions.NoWizardPageException.class, code = -32600,
            data = "204" /*per convention the data property contains the status code*/),
    ...
    public String executeToNextPage(@JsonRpcParam(value="jobId") java.util.UUID jobId, Boolean async, Long timeout, @JsonRpcParam(value="requestBody") java.util.Map<String, String> requestBody)  throws ServiceExceptions.NoWizardPageException, ServiceExceptions.InvalidSettingsException, ServiceExceptions.TimeoutException {
