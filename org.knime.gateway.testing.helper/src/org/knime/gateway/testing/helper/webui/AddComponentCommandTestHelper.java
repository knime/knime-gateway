...
public class AddComponentCommandTestHelper extends WebUIGatewayServiceTestHelper {
    ...
    public AddComponentCommandTestHelper(final ResultChecker entityResultChecker,
    ...
    public void testAddComponentCommand() throws Exception {
        ...
        var workflow = ws().getWorkflow(projectId, NodeIDEnt.getRootID(), Boolean.TRUE, null);
        System.out.println();
    }
