...
public class DeleteComponentPlaceholderCommandTestHelper extends WebUIGatewayServiceTestHelper {
    ...
    public DeleteComponentPlaceholderCommandTestHelper(final ResultChecker entityResultChecker,
    ...
    public void testCancelAndRetryComponentLoadJob() throws Exception {
        ...
        command = builder(DeleteComponentPlaceholderCommandEntBuilder.class) //
            .setKind(KindEnum.DELETE_COMPONENT_PLACEHOLDER) //)
            .setPlaceholderId(commandResult.getNewPlaceholderId()) //
            .build();
