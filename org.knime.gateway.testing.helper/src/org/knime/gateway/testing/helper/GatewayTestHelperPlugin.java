 ...
 *
 * History
 *   Nov 24, 2023 (hornm): created
 */

@SuppressWarnings("javadoc")
public class GatewayTestHelperPlugin implements BundleActivator {
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        // the component description which is used by tests (see SubNodeContainer#getDialogDescriptions and
