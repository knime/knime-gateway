...
import org.knime.gateway.impl.entity.DefaultMetaNodeDialogCompEnt.DefaultMetaNodeDialogCompEntBuilder;
...
public interface MetaNodeDialogCompEntMixIn extends MetaNodeDialogCompEnt {
    ...
    public static interface MetaNodeDialogCompEntMixInBuilder extends MetaNodeDialogCompEntBuilder {
        ...
        @Override
        @JsonProperty("nodeID")
        public MetaNodeDialogCompEntMixInBuilder setNodeID(final org.knime.gateway.api.entity.NodeIDEnt nodeID);
