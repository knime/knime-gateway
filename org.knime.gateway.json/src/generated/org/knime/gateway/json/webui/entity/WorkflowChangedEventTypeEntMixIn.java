...
@JsonSerialize(as=WorkflowChangedEventTypeEnt.class)
...
public interface WorkflowChangedEventTypeEntMixIn extends WorkflowChangedEventTypeEnt {
    ...
    public static interface WorkflowChangedEventTypeEntMixInBuilder extends WorkflowChangedEventTypeEntBuilder {
        ...
        @Override
        public WorkflowChangedEventTypeEntMixIn build();
    
        @Override
        @JsonProperty("typeId")
        public WorkflowChangedEventTypeEntMixInBuilder setTypeId(final String typeId);
        ...
        @Override
        @JsonProperty("workflowId")
        public WorkflowChangedEventTypeEntMixInBuilder setWorkflowId(final org.knime.gateway.api.entity.NodeIDEnt workflowId);
