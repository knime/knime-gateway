...
@JsonSerialize(as=CollapseCommandEnt.class)
...
public interface CollapseCommandEntMixIn extends CollapseCommandEnt {
    ...
    public static interface CollapseCommandEntMixInBuilder extends CollapseCommandEntBuilder {
        ...
        @Override
        @JsonProperty("connectionBendpoints")
        public CollapseCommandEntMixInBuilder setConnectionBendpoints(final java.util.Map<String, java.util.List<Integer>> connectionBendpoints);
