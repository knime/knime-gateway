...
import org.knime.gateway.impl.webui.entity.DefaultNodeCategoryEnt.DefaultNodeCategoryEntBuilder;
...
@JsonSerialize(as=NodeCategoryEnt.class)
...
public interface NodeCategoryEntMixIn extends NodeCategoryEnt {
    ...
    public static interface NodeCategoryEntMixInBuilder extends NodeCategoryEntBuilder {
        ...
        @Override
        @JsonProperty("metadata")
        public NodeCategoryEntMixInBuilder setMetadata(final CategoryMetadataEnt metadata);
