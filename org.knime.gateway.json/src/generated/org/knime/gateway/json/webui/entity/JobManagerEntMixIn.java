...
import org.knime.gateway.impl.webui.entity.DefaultJobManagerEnt.DefaultJobManagerEntBuilder;
...
@JsonSerialize(as=JobManagerEnt.class)
...
public interface JobManagerEntMixIn extends JobManagerEnt {
    ...
    public static interface JobManagerEntMixInBuilder extends JobManagerEntBuilder {
        ...
        @Override
        @JsonProperty("type")
        public JobManagerEntMixInBuilder setType(final TypeEnum type);
        
        @Override
        @JsonProperty("custom")
        public JobManagerEntMixInBuilder setCustom(final CustomJobManagerEnt custom);
