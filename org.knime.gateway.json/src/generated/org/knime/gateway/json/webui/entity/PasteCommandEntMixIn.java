...
public interface PasteCommandEntMixIn extends PasteCommandEnt {
    ...
    public static interface PasteCommandEntMixInBuilder extends PasteCommandEntBuilder {
    
        @Override
        public PasteCommandEntMixIn build();
    
        @Override
        @JsonProperty("kind")
        public PasteCommandEntMixInBuilder setKind(final KindEnum kind);
        
        @Override
        @JsonProperty("content")
        public PasteCommandEntMixInBuilder setContent(final String content);
