...
@JsonDeserialize(builder=DefaultCutCommandEntBuilder.class)
@JsonSerialize(as=CutCommandEnt.class)
@jakarta.annotation.Generated(value = {"com.knime.gateway.codegen.GatewayCodegen", "src-gen/api/web-ui/configs/org.knime.gateway.json-config.json"})
public interface CutCommandEntMixIn extends CutCommandEnt {
    ...
    public static interface CutCommandEntMixInBuilder extends CutCommandEntBuilder {
    
        @Override
        public CutCommandEntMixIn build();
    
        @Override
        @JsonProperty("kind")
        public CutCommandEntMixInBuilder setKind(final KindEnum kind);
        
        @Override
        @JsonProperty("nodeIds")
        public CutCommandEntMixInBuilder setNodeIds(final java.util.List<org.knime.gateway.api.entity.NodeIDEnt> nodeIds);
        
        @Override
        @JsonProperty("annotationIds")
        public CutCommandEntMixInBuilder setAnnotationIds(final java.util.List<org.knime.gateway.api.entity.AnnotationIDEnt> annotationIds);
