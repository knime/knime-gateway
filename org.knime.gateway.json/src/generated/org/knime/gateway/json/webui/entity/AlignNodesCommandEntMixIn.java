...
public interface AlignNodesCommandEntMixIn extends AlignNodesCommandEnt {
    ...
    public static interface AlignNodesCommandEntMixInBuilder extends AlignNodesCommandEntBuilder {
        ...
        @Override
        @JsonProperty("annotationIds")
        public AlignNodesCommandEntMixInBuilder setAnnotationIds(final java.util.List<org.knime.gateway.api.entity.AnnotationIDEnt> annotationIds);
        
        @Override
        @JsonProperty("connectionBendpoints")
        public AlignNodesCommandEntMixInBuilder setConnectionBendpoints(final java.util.Map<String, java.util.List<Integer>> connectionBendpoints);
