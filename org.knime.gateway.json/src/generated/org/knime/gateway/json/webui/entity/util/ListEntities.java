...
import org.knime.gateway.json.webui.entity.SuggestAnnotationPayloadEntMixIn;
import org.knime.gateway.json.webui.entity.SuggestAnnotationRequestEntMixIn;
import org.knime.gateway.json.webui.entity.SuggestAnnotationResponseEntMixIn;
import org.knime.gateway.json.webui.entity.SuggestAnnotationResultEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(SuggestAnnotationPayloadEntMixIn.class);
        res.add(SuggestAnnotationRequestEntMixIn.class);
        res.add(SuggestAnnotationResponseEntMixIn.class);
        res.add(SuggestAnnotationResultEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(SuggestAnnotationPayloadEntMixIn.SuggestAnnotationPayloadEntMixInBuilder.class);
        res.add(SuggestAnnotationRequestEntMixIn.SuggestAnnotationRequestEntMixInBuilder.class);
        res.add(SuggestAnnotationResponseEntMixIn.SuggestAnnotationResponseEntMixInBuilder.class);
        res.add(SuggestAnnotationResultEntMixIn.SuggestAnnotationResultEntMixInBuilder.class);
