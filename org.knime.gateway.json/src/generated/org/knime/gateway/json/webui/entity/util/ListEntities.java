...
import org.knime.gateway.json.webui.entity.PlaceholderNodeEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(PlaceholderNodeEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(PlaceholderNodeEntMixIn.PlaceholderNodeEntMixInBuilder.class);
