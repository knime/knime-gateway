...
import org.knime.gateway.json.webui.entity.NodeDialogEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(NodeDialogEntMixIn.class);
        ...
        res.add(SingleNodeEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(NodeDialogEntMixIn.NodeDialogEntMixInBuilder.class);
        ...
        res.add(SingleNodeEntMixIn.SingleNodeEntMixInBuilder.class);
