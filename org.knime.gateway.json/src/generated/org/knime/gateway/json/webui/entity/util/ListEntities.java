...
import org.knime.gateway.json.webui.entity.AddPlaceholderResultEntMixIn;
...
import org.knime.gateway.json.webui.entity.PlaceholderEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(AddPlaceholderResultEntMixIn.class);
        ...
        res.add(PlaceholderEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(AddPlaceholderResultEntMixIn.AddPlaceholderResultEntMixInBuilder.class);
        ...
        res.add(PlaceholderEntMixIn.PlaceholderEntMixInBuilder.class);
