...
import org.knime.gateway.json.webui.entity.NodeRecommendationsEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(NodeRecommendationsEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(NodeRecommendationsEntMixIn.NodeRecommendationsEntMixInBuilder.class);
