...
import org.knime.gateway.json.webui.entity.AutoConnectOptionsEntMixIn;
...
import org.knime.gateway.json.webui.entity.ChangeComponentLinkCommandEntMixIn;
...
import org.knime.gateway.json.webui.entity.ComponentSearchItemEntMixIn;
import org.knime.gateway.json.webui.entity.ComponentSearchItemPortEntMixIn;
...
import org.knime.gateway.json.webui.entity.CurrentStateEntMixIn;
...
import org.knime.gateway.json.webui.entity.InsertionOptionsEntMixIn;
...
import org.knime.gateway.json.webui.entity.KaiInquiryEntMixIn;
import org.knime.gateway.json.webui.entity.KaiInquiryOptionEntMixIn;
import org.knime.gateway.json.webui.entity.KaiInquiryResponseEntMixIn;
import org.knime.gateway.json.webui.entity.KaiMessageEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionContextEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionErrorEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionGenerateAnnotationContextEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionGenerateAnnotationRequestEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionGenerateAnnotationResponseEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionGenerateAnnotationResultEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionRequestEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionResponseEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionResultEntMixIn;
import org.knime.gateway.json.webui.entity.KaiQuickActionsAvailableEntMixIn;
...
import org.knime.gateway.json.webui.entity.LinkVariantInfoEntMixIn;
import org.knime.gateway.json.webui.entity.LoadErrorMissingExtensionEntMixIn;
import org.knime.gateway.json.webui.entity.LoadErrorsEntMixIn;
...
import org.knime.gateway.json.webui.entity.MostRecentEntMixIn;
import org.knime.gateway.json.webui.entity.NamedItemVersionEntMixIn;
...
import org.knime.gateway.json.webui.entity.OwnerEntMixIn;
...
import org.knime.gateway.json.webui.entity.ReplacementOptionsEntMixIn;
import org.knime.gateway.json.webui.entity.SelectionEventEntMixIn;
import org.knime.gateway.json.webui.entity.ShareComponentCommandEntMixIn;
import org.knime.gateway.json.webui.entity.ShareComponentResultEntMixIn;
...
import org.knime.gateway.json.webui.entity.SpecificVersionEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(ComponentSearchItemEntMixIn.class);
        res.add(ComponentSearchItemPortEntMixIn.class);
        ...
        res.add(CurrentStateEntMixIn.class);
        ...
        res.add(InsertionOptionsEntMixIn.class);
        res.add(ItemVersionEntMixIn.class);
        res.add(JobManagerEntMixIn.class);
        res.add(KaiFeedbackEntMixIn.class);
        res.add(KaiInquiryEntMixIn.class);
        res.add(KaiInquiryOptionEntMixIn.class);
        res.add(KaiInquiryResponseEntMixIn.class);
        res.add(KaiMessageEntMixIn.class);
        res.add(KaiQuickActionContextEntMixIn.class);
        res.add(KaiQuickActionErrorEntMixIn.class);
        res.add(KaiQuickActionGenerateAnnotationContextEntMixIn.class);
        res.add(KaiQuickActionGenerateAnnotationRequestEntMixIn.class);
        res.add(KaiQuickActionGenerateAnnotationResponseEntMixIn.class);
        res.add(KaiQuickActionGenerateAnnotationResultEntMixIn.class);
        res.add(KaiQuickActionRequestEntMixIn.class);
        res.add(KaiQuickActionResponseEntMixIn.class);
        res.add(KaiQuickActionResultEntMixIn.class);
        res.add(KaiQuickActionsAvailableEntMixIn.class);
        ...
        res.add(LinkVariantInfoEntMixIn.class);
        res.add(LoadErrorMissingExtensionEntMixIn.class);
        res.add(LoadErrorsEntMixIn.class);
        ...
        res.add(MostRecentEntMixIn.class);
        res.add(NamedItemVersionEntMixIn.class);
        ...
        res.add(ReplacementOptionsEntMixIn.class);
        res.add(SelectionEventEntMixIn.class);
        res.add(ShareComponentCommandEntMixIn.class);
        res.add(ShareComponentResultEntMixIn.class);
        ...
        res.add(SpecificVersionEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(AutoConnectOptionsEntMixIn.AutoConnectOptionsEntMixInBuilder.class);
        ...
        res.add(ChangeComponentLinkCommandEntMixIn.ChangeComponentLinkCommandEntMixInBuilder.class);
        ...
        res.add(ComponentSearchItemEntMixIn.ComponentSearchItemEntMixInBuilder.class);
        res.add(ComponentSearchItemPortEntMixIn.ComponentSearchItemPortEntMixInBuilder.class);
        ...
        res.add(CurrentStateEntMixIn.CurrentStateEntMixInBuilder.class);
        ...
        res.add(InsertionOptionsEntMixIn.InsertionOptionsEntMixInBuilder.class);
        res.add(ItemVersionEntMixIn.ItemVersionEntMixInBuilder.class);
        res.add(JobManagerEntMixIn.JobManagerEntMixInBuilder.class);
        res.add(KaiFeedbackEntMixIn.KaiFeedbackEntMixInBuilder.class);
        res.add(KaiInquiryEntMixIn.KaiInquiryEntMixInBuilder.class);
        res.add(KaiInquiryOptionEntMixIn.KaiInquiryOptionEntMixInBuilder.class);
        res.add(KaiInquiryResponseEntMixIn.KaiInquiryResponseEntMixInBuilder.class);
        res.add(KaiMessageEntMixIn.KaiMessageEntMixInBuilder.class);
        res.add(KaiQuickActionContextEntMixIn.KaiQuickActionContextEntMixInBuilder.class);
        res.add(KaiQuickActionErrorEntMixIn.KaiQuickActionErrorEntMixInBuilder.class);
        res.add(KaiQuickActionGenerateAnnotationContextEntMixIn.KaiQuickActionGenerateAnnotationContextEntMixInBuilder.class);
        res.add(KaiQuickActionGenerateAnnotationRequestEntMixIn.KaiQuickActionGenerateAnnotationRequestEntMixInBuilder.class);
        res.add(KaiQuickActionGenerateAnnotationResponseEntMixIn.KaiQuickActionGenerateAnnotationResponseEntMixInBuilder.class);
        res.add(KaiQuickActionGenerateAnnotationResultEntMixIn.KaiQuickActionGenerateAnnotationResultEntMixInBuilder.class);
        res.add(KaiQuickActionRequestEntMixIn.KaiQuickActionRequestEntMixInBuilder.class);
        res.add(KaiQuickActionResponseEntMixIn.KaiQuickActionResponseEntMixInBuilder.class);
        res.add(KaiQuickActionResultEntMixIn.KaiQuickActionResultEntMixInBuilder.class);
        res.add(KaiQuickActionsAvailableEntMixIn.KaiQuickActionsAvailableEntMixInBuilder.class);
        ...
        res.add(LinkVariantInfoEntMixIn.LinkVariantInfoEntMixInBuilder.class);
        res.add(LoadErrorMissingExtensionEntMixIn.LoadErrorMissingExtensionEntMixInBuilder.class);
        res.add(LoadErrorsEntMixIn.LoadErrorsEntMixInBuilder.class);
        ...
        res.add(MostRecentEntMixIn.MostRecentEntMixInBuilder.class);
        res.add(NamedItemVersionEntMixIn.NamedItemVersionEntMixInBuilder.class);
        ...
        res.add(OwnerEntMixIn.OwnerEntMixInBuilder.class);
        ...
        res.add(ReplacementOptionsEntMixIn.ReplacementOptionsEntMixInBuilder.class);
        res.add(SelectionEventEntMixIn.SelectionEventEntMixInBuilder.class);
        res.add(ShareComponentCommandEntMixIn.ShareComponentCommandEntMixInBuilder.class);
        res.add(ShareComponentResultEntMixIn.ShareComponentResultEntMixInBuilder.class);
        ...
        res.add(SpecificVersionEntMixIn.SpecificVersionEntMixInBuilder.class);
