...
import org.knime.gateway.json.webui.entity.TranslateOperationEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(TranslateOperationEntMixIn.class);
        ...
        res.add(WorkflowOperationEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(TranslateOperationEntMixIn.TranslateOperationEntMixInBuilder.class);
        ...
        res.add(WorkflowOperationEntMixIn.WorkflowOperationEntMixInBuilder.class);
