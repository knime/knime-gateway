...
import org.knime.gateway.json.webui.entity.SpaceProviderAndConnectionEntMixIn;
import org.knime.gateway.json.webui.entity.SpaceProviderEntMixIn;
import org.knime.gateway.json.webui.entity.SpaceProvidersChangedEventEntMixIn;
import org.knime.gateway.json.webui.entity.SpaceProvidersChangedEventTypeEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(SpaceProviderAndConnectionEntMixIn.class);
        res.add(SpaceProviderEntMixIn.class);
        res.add(SpaceProvidersChangedEventEntMixIn.class);
        res.add(SpaceProvidersChangedEventTypeEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(SpaceProviderAndConnectionEntMixIn.SpaceProviderAndConnectionEntMixInBuilder.class);
        res.add(SpaceProviderEntMixIn.SpaceProviderEntMixInBuilder.class);
        res.add(SpaceProvidersChangedEventEntMixIn.SpaceProvidersChangedEventEntMixInBuilder.class);
        res.add(SpaceProvidersChangedEventTypeEntMixIn.SpaceProvidersChangedEventTypeEntMixInBuilder.class);
