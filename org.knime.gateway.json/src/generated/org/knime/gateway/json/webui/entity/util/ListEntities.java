...
import org.knime.gateway.json.webui.entity.HubResourceChangedEventTypeEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(HubResourceChangedEventEntMixIn.class);
        res.add(HubResourceChangedEventTypeEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(HubResourceChangedEventEntMixIn.HubResourceChangedEventEntMixInBuilder.class);
        res.add(HubResourceChangedEventTypeEntMixIn.HubResourceChangedEventTypeEntMixInBuilder.class);
