...
import org.knime.gateway.json.webui.entity.NodeSelectionEntMixIn;
import org.knime.gateway.json.webui.entity.NodeSelectionsEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(NodePortInvariantsEntMixIn.class);
        res.add(NodeSearchResultEntMixIn.class);
        res.add(NodeSelectionEntMixIn.class);
        res.add(NodeSelectionsEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(NodePortInvariantsEntMixIn.NodePortInvariantsEntMixInBuilder.class);
        res.add(NodeSearchResultEntMixIn.NodeSearchResultEntMixInBuilder.class);
        res.add(NodeSelectionEntMixIn.NodeSelectionEntMixInBuilder.class);
        res.add(NodeSelectionsEntMixIn.NodeSelectionsEntMixInBuilder.class);
