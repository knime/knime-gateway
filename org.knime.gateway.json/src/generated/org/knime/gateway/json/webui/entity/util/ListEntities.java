...
import org.knime.gateway.json.webui.entity.SyncStateDetailsEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(SyncStateDetailsEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(SyncStateDetailsEntMixIn.SyncStateDetailsEntMixInBuilder.class);
