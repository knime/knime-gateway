...
import org.knime.gateway.json.webui.entity.UpdateStateChangedEventEntMixIn;
import org.knime.gateway.json.webui.entity.UpdateStateChangedEventTypeEntMixIn;
...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(UpdateStateChangedEventEntMixIn.class);
        res.add(UpdateStateChangedEventTypeEntMixIn.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(UpdateStateChangedEventEntMixIn.UpdateStateChangedEventEntMixInBuilder.class);
        res.add(UpdateStateChangedEventTypeEntMixIn.UpdateStateChangedEventTypeEntMixInBuilder.class);
