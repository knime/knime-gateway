...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(MetaNodeDialogComp_configEnt.class);
        res.add(MetaNodeDialogComp_representationEnt.class);
        res.add(MetaNodeDialogComp_valueEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(MetaNodeDialogComp_configEnt.MetaNodeDialogComp_configEntBuilder.class);
        res.add(MetaNodeDialogComp_representationEnt.MetaNodeDialogComp_representationEntBuilder.class);
        res.add(MetaNodeDialogComp_valueEnt.MetaNodeDialogComp_valueEntBuilder.class);
        ...
        res.add(ViewContentEnt.ViewContentEntBuilder.class);
