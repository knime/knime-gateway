...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(ViewData_viewRepresentationEnt.class);
        res.add(ViewData_viewValueEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(ViewData_viewRepresentationEnt.ViewData_viewRepresentationEntBuilder.class);
        res.add(ViewData_viewValueEnt.ViewData_viewValueEntBuilder.class);
