...
public class ListEntities {
    ...
    public static List<Class<?>> listEntityClasses() {
        ...
        res.add(WebViewEnt.class);
        res.add(WebView_viewRepresentationEnt.class);
        res.add(WebView_viewValueEnt.class);
    ...
    public static List<Class<?>> listEntityBuilderClasses() {
        ...
        res.add(WebViewEnt.WebViewEntBuilder.class);
        res.add(WebView_viewRepresentationEnt.WebView_viewRepresentationEntBuilder.class);
        res.add(WebView_viewValueEnt.WebView_viewValueEntBuilder.class);
